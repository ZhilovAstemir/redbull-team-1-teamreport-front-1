      ...
      >
        <div className={styles.accordion__content}>
          <div className={styles.accordion__date}>
            {props.isMyReports
              ? formatDate(props.report.week.dateStart) +
                " - " +
                formatDate(props.report.week.dateEnd)
      ...
      <AccordionDetails>
        <div className={styles.accordionDetails__content}>
          <div className={styles.badge__group}>
            ...
            >
              {renderEmotion(props.report.morale)}
              <div className={styles.badge__title}>MORALE</div>
            </div>
            <div className={styles.badge__comment}>
              {props.report.moraleComment
                ? props.report.moraleComment
          ...
          <div className={styles.badge__group}>
            ...
            >
              {renderEmotion(props.report.stress)}
              <div className={styles.badge__title}>STRESS</div>
            </div>
            <div className={styles.badge__comment}>
              {props.report.stressComment
                ? props.report.stressComment
          ...
          <div className={styles.badge__group}>
            ...
            >
              {renderEmotion(props.report.workload)}
              <div className={styles.badge__title}>WORKLOAD</div>
            </div>
            <div className={styles.badge__comment}>
              {props.report.workloadComment
                ? props.report.workloadComment
          ...
          <div className={styles.comment__group}>
            <div>Weekly High</div>
            <div className={styles.comment__text}>{props.report.high}</div>
          </div>
          <div className={styles.comment__group}>
            <div>Weekly Low</div>
            <div className={styles.comment__text}>{props.report.low}</div>
          </div>
          <div className={styles.comment__group}>
            <div>Anything Else</div>
            <div className={styles.comment__text}>{props.report.else}</div>
          </div>
        </div>
      </AccordionDetails>
    </Accordion>
